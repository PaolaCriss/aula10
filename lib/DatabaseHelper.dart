...
// Importando o pacote path para manipulação de caminhos de arquivos
    ...
    return openDatabase(
      ...
      onCreate: (db, version) {
        ...
        return db.execute(
          ...
          'CREATE TABLE tarefa(id INTEGER PRIMARY KEY AUTOINCREMENT, titulo TEXT, description TEXT)', // Cria a tabela 'tarefas'
        );
      },
